...
def uber_intent(intent_request):
    ...
    resultData = "https://m.uber.com/looking/finalize?destination=%7B%22latitude%22:" + str(
        arr1[int(uber) - 1]) + ",%22longitude%22:" + str(arr2[int(uber) - 1]) + ",%22title%22:%22" + str(
        bus[int(uber) - 1]).strip().replace(' ',
                                            '%20') + "%22title%7D&vehicleView=a1111c8c-c720-46c3-8534-2fcdd730040d&link_text=View%20team%20roster&partner_deeplink=partner%3A%2F%2Fteam%2F9383"
